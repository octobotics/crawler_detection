// Generated by gencpp from file detectron2ros/Result.msg
// DO NOT EDIT!


#ifndef DETECTRON2ROS_MESSAGE_RESULT_H
#define DETECTRON2ROS_MESSAGE_RESULT_H
...
struct Result_
{
  ...
  typedef boost::shared_ptr< ::detectron2ros::Result_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::detectron2ros::Result_<ContainerAllocator> const> ConstPtr;

}; // struct Result_

typedef ::detectron2ros::Result_<std::allocator<void> > Result;

typedef boost::shared_ptr< ::detectron2ros::Result > ResultPtr;
typedef boost::shared_ptr< ::detectron2ros::Result const> ResultConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::detectron2ros::Result_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::detectron2ros::Result_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::detectron2ros::Result_<ContainerAllocator1> & lhs, const ::detectron2ros::Result_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::detectron2ros::Result_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::detectron2ros::Result_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::detectron2ros::Result_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::detectron2ros::Result_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::detectron2ros::Result_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::detectron2ros::Result_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::detectron2ros::Result_<ContainerAllocator> >
{
  ...
  static const char* value(const ::detectron2ros::Result_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5a75b825f87d437eULL;
  static const uint64_t static_value2 = 0x076ac357fe9ef89cULL;
};

template<class ContainerAllocator>
struct DataType< ::detectron2ros::Result_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::detectron2ros::Result_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::detectron2ros::Result_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::detectron2ros::Result_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::detectron2ros::Result_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DETECTRON2ROS_MESSAGE_RESULT_H
